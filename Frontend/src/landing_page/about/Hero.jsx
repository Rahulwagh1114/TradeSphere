function Hero() {
    return (
        <div className="container mt-5">
            ...
            <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight:"1.5rem",fontSize:"1.2em"}}>
...
<p>A Over 1+ Crore clients place millions of orders every day through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.</p>
</div>
<div className="col-6 p-5">
    ...
    <p>And yet, we are always up to something new every d Catch up on the latest updates on our blog or s the media is saying about us.</p>
</div>
